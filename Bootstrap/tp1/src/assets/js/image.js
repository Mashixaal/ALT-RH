...
document.write(`<div class="jumbotron text-center"><h1>Le trombi des stars</h1></div>`);

let i = 0;
let lastpos =0;
for(let j = 0; j <26; j++){
    document.write('<div class="col-xs-6 col-sm-4 col-mmd-2">');
    document.write('<img src="images/'+1+'.jpg" alt=""></img>');
    document.write('</div>');
    if(i < 48){
        document.write('<div class="col-xs-6 col-sm-4 col-mmd-2">');
        document.write('<img src="images/'+1+'.jpg" alt=""></img>');
